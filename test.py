...
class RunExpenseTests:
    def __init__(self):
        self.run_number = int(sys.argv[2])
        self.url = sys.argv[1]
    ...
    def test_response(self, response, code, message=None):
        ...
        if self.max_score != self.total_score:
            print(message, response.json(), code, response.status_code)
    ...
    def test_add_expense(self):
        ...
        response = requests.post(self.add_expense_url, {})
        self.test_response(
            response,
            400,
            {'message': 'vendor code not passed.'}
        ...
        response = requests.post(self.add_expense_url, {'vendor_code': '1234'})
        self.test_response(
            response,
            400,
            {'message': 'employee code not passed.'}
